...
def analyse_video(video_id):
    ...
    if len(cleaned_comments) == 0:
        return "Aucun commentaire anglais n'a été trouvé sur cette vidéo.", 0
    ...
    score = sum(polarities) / len(polarities) if polarities else 0
    ...
    resume = (
        ...
        f"🕒 Temps d'exécution : {execution_time:.2f} secondes\n"
